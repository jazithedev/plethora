$(function() {
	...
	$('div.form form img.multilang_button').click(function() {
		...
		var oBox = $(this).closest('div.form-group');

		oBox.find('img.multilang_checked').removeClass('multilang_checked');
		$(this).addClass('multilang_checked');

		oBox.find('div.form-field-lang').css('display', 'none');
		oBox.find('div.form-field-lang-' + sLang).css('display', 'block');
	});
